...
def extract(group):
    pre = group.group(1).strip('_') if my_search.group(1) else None
    family = group.group(2).strip('_') if my_search.group(2) else None
    infix = group.group(3).strip('_') if my_search.group(3) else None
    drive = group.group(4).strip('_') if my_search.group(4) else None
